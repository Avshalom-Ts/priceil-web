    ...
    return (
        <div className="flex flex-col gap-10">
            <header className="flex flex-col gap-2">
                <h1 className="text-3xl font-bold tracking-tight">רשתות המזון בארץ</h1>
            ...
            <section className="flex flex-col gap-4 rounded-xl border border-border p-5">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                    <div className="rounded-lg border border-border p-3 text-xs text-muted-foreground">
                        <p className="mb-1 font-semibold text-foreground">Authentication</p>
                        אפשרי ללא API key. אם תשלחו מפתח בתשלום, המגבלות יחולו לפי התוכנית.
                    </div>
                    <div className="rounded-lg border border-border p-3 text-xs text-muted-foreground">
            ...
            <section className="flex flex-col gap-4">
                ...
                <CodeBlock>{`curl "https://api.priceil.dev/stores/chains"`}</CodeBlock>
            </section>
